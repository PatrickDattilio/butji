...
export async function getCompanyById(id: string): Promise<Company | null> {
  try {
    ...
    return {
      ...
      unionInfo: company.unionInfo ? (JSON.parse(company.unionInfo) as Company['unionInfo']) : undefined,
      employeeCount: company.employeeCount || undefined,
      socialMedia: company.socialMedia ? (JSON.parse(company.socialMedia) as Company['socialMedia']) : undefined,
...
export async function createCompany(company: Omit<Company, 'id' | 'createdAt' | 'updatedAt'>): Promise<Company> {
  ...
  const created = await prisma.company.create({
    data: {
      ...
      locations: company.locations ? JSON.stringify(company.locations) : null,
      directAction: company.directAction ? JSON.stringify(company.directAction) : null,
      unionInfo: company.unionInfo ? JSON.stringify(company.unionInfo) : null,
      employeeCount: company.employeeCount || null,
      socialMedia: company.socialMedia ? JSON.stringify(company.socialMedia) : null,
      contactInfo: company.contactInfo ? JSON.stringify(company.contactInfo) : null,
      slug,
    ...
    return {
      ...
      locations: created.locations ? (JSON.parse(created.locations) as Company['locations']) : undefined,
      directAction: created.directAction ? (JSON.parse(created.directAction) as Company['directAction']) : undefined,
      unionInfo: created.unionInfo ? (JSON.parse(created.unionInfo) as Company['unionInfo']) : undefined,
      employeeCount: created.employeeCount || undefined,
      socialMedia: created.socialMedia ? (JSON.parse(created.socialMedia) as Company['socialMedia']) : undefined,
      contactInfo: created.contactInfo ? (JSON.parse(created.contactInfo) as Company['contactInfo']) : undefined,
...
export async function updateCompany(id: string, company: Partial<Omit<Company, 'id' | 'createdAt' | 'updatedAt'>>): Promise<Company> {
  ...
  const updateData: any = {
    ...
    locations: company.locations ? JSON.stringify(company.locations) : undefined,
    directAction: company.directAction ? JSON.stringify(company.directAction) : undefined,
      unionInfo: company.unionInfo ? JSON.stringify(company.unionInfo) : undefined,
      employeeCount: company.employeeCount || undefined,
      socialMedia: company.socialMedia ? JSON.stringify(company.socialMedia) : undefined,
      contactInfo: company.contactInfo ? JSON.stringify(company.contactInfo) : undefined,
      featured: company.featured,
    approved: company.approved,
  }
  ...
  return {
    ...
    layoffs: updated.layoffs ? (JSON.parse(updated.layoffs) as Company['layoffs']) : undefined,
      ...
      locations: updated.locations ? (JSON.parse(updated.locations) as Company['locations']) : undefined,
      directAction: updated.directAction ? (JSON.parse(updated.directAction) as Company['directAction']) : undefined,
      unionInfo: updated.unionInfo ? (JSON.parse(updated.unionInfo) as Company['unionInfo']) : undefined,
      employeeCount: updated.employeeCount || undefined,
      socialMedia: updated.socialMedia ? (JSON.parse(updated.socialMedia) as Company['socialMedia']) : undefined,
      contactInfo: updated.contactInfo ? (JSON.parse(updated.contactInfo) as Company['contactInfo']) : undefined,
